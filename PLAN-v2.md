...
### 3.3 Чек-лист
- [ ] `ToggleGroup` Board/Table в шапке доски.
- [ ] `TaskTable` с сортировкой по столбцам.
- [ ] URL-state для `view`, `sort`, `dir`.
- [ ] Открытие задачи в модалке из строки таблицы.
- [ ] Адаптив: на узких экранах часть колонок скрывается (overflow-x-auto в крайнем случае).
- [ ] Коммит «этап 10: табличный вид задач».
...
### 4.3 Чек-лист
- [ ] Миграция 0005 (task_templates).
- [ ] services/templates.ts.
- [ ] actions/templates.ts.
- [ ] Страница settings/templates с CRUD.
- [ ] Селектор «Из шаблона» в NewTaskForm.
- [ ] «⋯ → Сохранить как шаблон» с диалогом.
- [ ] Коммит «этап 11: шаблоны задач».
